...
-  auth client testing requires a KBase CI auth token (or wherever configured) and KBase user id. These should be in environment variables `KBASE_TEST_TOKEN` and `KBASE_TEST_USER`, respectively.
