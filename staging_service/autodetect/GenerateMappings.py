...
app_id_to_title = {
    ...
    upload_specification: "Upload Specification",
}
...
file_format_to_app_mapping[CSV] = [sample_set_id, upload_specification]
file_format_to_app_mapping[TSV] = [
    media_id, expression_matrix_id, metabolic_annotations_id, metabolic_annotations_bulk_id,
    fba_model_id, phenotype_set_id, upload_specification]
file_format_to_app_mapping[EXCEL] = [sample_set_id, media_id, fba_model_id, upload_specification]
